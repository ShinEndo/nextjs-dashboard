...
const FormSchema = z.object({
    ...
    amount: z.coerce.number().gt(0,{message: 'Pleaseenter an amount greater than $0.'}),
...
export async function createInvoice(prevState: State, formData: FormData){
    ...
    try {
        ...
        return {
            maeeage: 'Database Error: Failed to Create Invoice.',
        };
    }
...
export async function updateInvoice(id:string, prevState: State, formData: FormData){
    ...
    try {
        ...
        return {
            message: 'Database Error: Failrd to Update Invoice.'
        };
    }
